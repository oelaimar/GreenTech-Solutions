<x-admin-layout>
    <div class="max-w-2xl mx-auto">
        <!-- Page Heading -->
        <div class="mb-8">
            <h2 class="text-3xl font-black tracking-tight">Add New Product</h2>
            <p class="text-[#638863] dark:text-[#a3b8a3] mt-1 font-medium">Expand your sustainable inventory.</p>
        </div>
        ...
        <div class="bg-white dark:bg-[#1a2e1a] rounded-xl border border-[#dce5dc] dark:border-white/10 shadow-sm overflow-hidden p-8">
            <form action="{{ route('products.store') }}" method="POST" class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="description" rows="4" class="w-full bg-[#f0f4f0] dark:bg-white/5 border-none rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-primary/50 text-[#111811] dark:text-white placeholder-[#638863]" placeholder="Describe the plant..."></textarea>
                </div>
