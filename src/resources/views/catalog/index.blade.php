            ...
            @foreach($products as $product)
                ...
                <div class="flex flex-col gap-4 bg-white dark:bg-[#1a2e1a] p-4 rounded-xl border border-[#e0e8e0] dark:border-[#223322] shadow-sm hover:shadow-md transition-shadow group duration-300">
                    <div class="relative w-full overflow-hidden rounded-lg">
                        <!-- Placeholder image since specific image attribute wasn't visible in original code. Using unsplash with keyword based on name or 'plant' -->
                        <div class="w-full bg-center bg-no-repeat aspect-[4/5] bg-cover transition-transform duration-500 group-hover:scale-105" 
                             style="background-image: url('https://source.unsplash.com/random/400x500/?plant,{{ urlencode($product->name) }}');">
                        </div>
